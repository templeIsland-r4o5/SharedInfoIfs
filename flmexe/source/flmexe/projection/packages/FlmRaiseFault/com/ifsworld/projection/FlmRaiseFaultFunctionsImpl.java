...
/*
 * Implementation class for all global functions defined in the FlmRaiseFault projection model.
 * Note: Functions should not change database state!
 */

@Stateless(name="FlmRaiseFaultFunctions")
public class FlmRaiseFaultFunctionsImpl implements FlmRaiseFaultFunctions {
   ...
   private static final String RAISE_FAULT_SOURCE = "RaiseFaultAssistant";
   ...
   public Map<String, Object> getFailedSystemSensitivity(final Map<String, Object> parameters, final Connection connection) {
      ...
      try{
         ...
         responseJson = new EffectiveSensitivitiesResponseTransformer().transformMtxSensitivityResponseJsonIntoIfsProjectionStructure(sensitivityApiResponseJson, RAISE_FAULT_SOURCE);
